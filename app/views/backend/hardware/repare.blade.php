...
{{-- Page title --}}
@section('title')
     @lang('admin/hardware/general.repare') ::
@parent
@stop
...
<div class="row header">
    <div class="col-md-12">
        ...
        <h3> @lang('admin/hardware/general.repare')</h3>
    </div>
</div>
        ...
        <form class="form-horizontal" method="post" action="" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <button type="submit" class="btn btn-success"><i class="icon-ok icon-white"></i>@lang('general.repare')</button>
                </div>
            </div>
